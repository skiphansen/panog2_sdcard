...
#define DO /* Test for MMC DO ('H':true, 'L':false) */ \
   (REG_RD(GPIO_BASE + GPIO_INPUT) & SD_SO_BIT)

#define DI_INIT() /* Initialize port for MMC DI as output */ \
   REG_WR(GPIO_BASE + GPIO_DIRECTION,REG_RD(GPIO_BASE + GPIO_DIRECTION) | SD_SI_BIT)

#define DI_H()    /* Set MMC DI "high" */ \
   REG_WR(GPIO_BASE + GPIO_OUTPUT_SET,SD_SI_BIT)

#define DI_L()    /* Set MMC DI "low" */ \
   REG_WR(GPIO_BASE + GPIO_OUTPUT_CLR,SD_SI_BIT)

#define CK_INIT() /* Initialize port for MMC SCLK as output */ \
   REG_WR(GPIO_BASE + GPIO_DIRECTION,REG_RD(GPIO_BASE + GPIO_DIRECTION) | SD_CLK_BIT)

#define CK_H()    /* Set MMC SCLK "high" */ \
   REG_WR(GPIO_BASE + GPIO_OUTPUT_SET,SD_CLK_BIT)

#define CK_L()    /* Set MMC SCLK "low" */ \
   REG_WR(GPIO_BASE + GPIO_OUTPUT_CLR,SD_CLK_BIT)

#define CS_INIT() /* Initialize port for MMC CS as output */ \
   REG_WR(GPIO_BASE + GPIO_DIRECTION,REG_RD(GPIO_BASE + GPIO_DIRECTION) | SD_CS_BIT)

#define CS_H()    /* Set MMC CS "high" */ \
   REG_WR(GPIO_BASE + GPIO_OUTPUT_SET,SD_CS_BIT)

#define CS_L()    /* Set MMC CS "low" */ \
   REG_WR(GPIO_BASE + GPIO_OUTPUT_CLR,SD_CS_BIT)
